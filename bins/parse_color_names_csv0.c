...
struct parser_args_t {
  char *mode;
  FILE *input_fd;    FILE *output_fd;
  char *input_file;  char *output_file; char *template;
  bool verbose_mode; bool test_mode; bool render_template;
};
struct render_t {
...
//    parser_args->input_fd = fopen(STDIN_FILENO, "r");
    char buf[1024];
