...
static void type_mem(const char *str, size_t len, enum libterminput_type type) {
  alarm(5);
  if (len) {
...
static void keypress_(const char *str1, const char *str2, const char *str3, const char *str4,
...
static void keypress(const char *a, const char *b, enum libterminput_key key, enum libterminput_mod mods) {
...
static void keynum_(const char *a, const char *b, const char *c, enum libterminput_key key, enum libterminput_mod mods) {
...
static void keynum(int num, enum libterminput_key key, enum libterminput_mod mods) {
...
static void keypress_special_char(char chr, enum libterminput_key key) {
  buffer[0] = chr;
  buffer[1] = '\0';
...
static void mouse(const char *str, enum libterminput_event ev, enum libterminput_button btn, enum libterminput_mod mods, size_t x, size_t y) {
...
static void mouseho(const char *str, size_t sx, size_t sy, size_t ex, size_t ey, size_t mx, size_t my) {
  TYPE(str, LIBTERMINPUT_MOUSEEVENT);
