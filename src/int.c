...
uint16_t read_u16_le(unsigned char *buf) {
  uint16_t n = 0;
...
uint32_t read_u32_le(unsigned char *buf) {
  uint32_t n = 0;
...
uint64_t read_u64_le(unsigned char *buf) {
  uint64_t n = 0;
...
void write_u16_le(unsigned char *buf, uint16_t n) {
  buf[1] = n >> 8 & 0xff;
  buf[0] = n & 0xff;
}
...
void write_u32_le(unsigned char *buf, uint32_t n) {
  buf[3] = n >> 24 & 0xff;
  buf[2] = n >> 16 & 0xff;
  buf[1] = n >> 8 & 0xff;
  buf[0] = n & 0xff;
...
void write_u64_le(unsigned char *buf, uint64_t n) {
  buf[7] = n >> 56 & 0xff;
  buf[6] = n >> 48 & 0xff;
  buf[5] = n >> 40 & 0xff;
  buf[4] = n >> 32 & 0xff;
